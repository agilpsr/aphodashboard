...
def render_dashboard(selected_key):
    ...
    with st.sidebar:
        ...
        if col_zone and col_zone in df_filtered.columns:
            ...
            sel = st.multiselect(f"Filter by Zone", opts, key=f"zone_filter_{selected_key}")
        ...
        if col_subzone and col_subzone in df_filtered.columns:
            ...
            sel = st.multiselect(f"Filter by SubZone", opts, key=f"subzone_filter_{selected_key}")
